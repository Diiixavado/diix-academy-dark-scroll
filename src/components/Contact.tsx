      ...
      <div className="container-responsive relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 3xl:gap-16 max-w-6xl 3xl:max-w-7xl mx-auto">
              ...
              <div className="space-y-3 sm:space-y-4">
                {contactInfo.map((item, index) => (
                  <a
                    key={item.title}
                    href={item.href}
                    className="glass-card-hover flex items-center gap-4 sm:gap-5 p-4 sm:p-5 3xl:p-6 rounded-xl sm:rounded-2xl group"
                  >
          ...
          <ScrollReveal animation="slide-right">
            <div className="fantasy-card rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 3xl:p-12">
