        ...
        <div className="flex items-center justify-between h-14 sm:h-16 lg:h-18 3xl:h-22">
          ...
          <div className="hidden lg:flex items-center gap-4">
            <Button 
              ...
              className="btn-fantasy px-4 xl:px-6 3xl:px-8 py-2 xl:py-2.5 3xl:py-3 font-semibold rounded-xl text-primary-foreground text-sm xl:text-base 3xl:text-lg group"
            >
      ...
      >
        <nav className="container-responsive py-6 flex flex-col gap-2">
          ...
          <Button 
            ...
            className="btn-fantasy mt-4 w-full py-4 font-semibold rounded-xl text-primary-foreground text-lg"
          >
