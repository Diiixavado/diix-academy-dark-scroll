      ...
      <div className="container-responsive relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-6 3xl:gap-8">
          {courses.map((course, index) => (
            <div
              key={course.title}
              className={`fantasy-card rounded-2xl sm:rounded-3xl p-5 sm:p-6 lg:p-6 3xl:p-8 transition-all duration-500 hover:scale-[1.02] group animate-fade-up ${
        ...
        {/* View All CTA */}
        <div className="text-center mt-10 sm:mt-14 lg:mt-16 3xl:mt-20 animate-fade-up delay-500">
